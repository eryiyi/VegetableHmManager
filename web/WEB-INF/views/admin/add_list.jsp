                ...
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <select class="form-control" id="mm_emp_type">
                            ...
                            <option value="0" ${query.mm_emp_type=='0'?'selected':''}>蔬菜经营</option>
                            <option value="1" ${query.mm_emp_type=='1'?'selected':''}>蔬菜会员</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <table class="table table-hover">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            ...
                            <td>
                                <c:if test="${e.mm_emp_company_type=='0'}">蔬菜</c:if>
                                <c:if test="${e.mm_emp_company_type=='1'}">菜园</c:if>
                            </td>
